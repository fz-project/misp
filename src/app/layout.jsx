...
const ogImage = `${siteUrl}/logo-misp.png`; // 1200x630+, public/logo/og.jpg
...
export const metadata = {
  ...
  title: {
    default:
      "Mikro Indo Sinergi Persada (MISP) – Telecommunication Engineering Indonesia",
    template: "%s | MISP",
  },
  ...
  icons: {
    icon: [
      { url: "/favicon.ico" }, // <-- penting untuk Google mobile
      { url: "/favicon-32x32.png", sizes: "32x32", type: "image/png" },
      { url: "/favicon-16x16.png", sizes: "16x16", type: "image/png" }, // opsional
    ],
    apple: [{ url: "/apple-touch-icon.png", sizes: "180x180" }],
    other: [
      { rel: "mask-icon", url: "/safari-pinned-tab.svg", color: "#0f172a" }, // <-- SVG
  ...
  keywords: [
    "MISP",
    "PT Mikro Indo Sinergi Persada",
    "Mikro Indo Sinergi Persada",
    "telecommunication engineering Indonesia",
    "engineering telekomunikasi nasional",
    "network rollout Indonesia",
    "FTTH Indonesia",
    "microwave link installation",
    "warehousing telekomunikasi",
    "scrap management Indonesia",
    ...
    "instalasi microwave link",
    "microwave link installation",
    "relokasi RAN",
    "RAN relocation",
    "dismantle jaringan",
    "dismantle outdoorisation",
    "upgrade kapasitas jaringan",
    "capacity upgrade",
    ...
    "warehouse Bali",
    "warehouse Mataram",
    "telecom warehouse Indonesia",
    "lokasi pergudangan telekomunikasi",
    "ISO 9001",
    "ISO 14001",
    "ISO 45001",
    "ISO 37001",
    "solusi end-to-end telekomunikasi",
    "telecommunication project management",
    "engineering projects Indonesia",
    "layanan nasional telekomunikasi",
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              sameAs: ["https://misp.co.id/", "https://www.mikroindosinergipersada.co.id/"],
            }),
          }}
        />
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "WebSite",
              name: "MISP",
              alternateName: "Mikro Indo Sinergi Persada",
              url: siteUrl,
              inLanguage: "id-ID",
              potentialAction: {
                "@type": "SearchAction",

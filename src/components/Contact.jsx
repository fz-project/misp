...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const phoneNumber = data.locations[0].phone.replace(/[^0-9]/g, ""); // ambil nomor WA tujuan
    const message = `
    ...
    // Reset form dan tampilkan status
    setIsSubmitted(true);
    setTimeout(() => {
      setIsSubmitted(false);
      setFormData({
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6 ">
                    <div className="grid md:grid-cols-2 gap-6">
                      <div>
                        ...
                        <input
                          ...
                          required
                          className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-300 text-red-600 placeholder:text-red-600/25 scroll-mt-64"
                    ...
                    <div>
                      ...
                      >
                        ...
                        <option value="telco-engineering">
                          Telco Engineering
                        </option>
                        <option value="ftth">FTTH Solutions</option>
                        <option value="network-optimization">
                          Network Optimization
                        </option>
                        <option value="scrap-management">
                          Scrap Management
                        </option>
                    ...
                    <Button
                      type="submit"
                      size="lg"
                      className="w-full bg-red-600 hover:bg-red-700 text-white px-8 py-4 text-lg transition-all duration-300 transform hover:scale-[103%] cursor-pointer"
                    >

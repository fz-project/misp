...
const Locations = () => {
  ...
  return (
    <section id="locations" className="py-20 bg-gray-50 scroll-mt-24 overflow-hidden">
      <div className="container mx-auto px-4 xl:px-10">
        ...
        {/* Coverage Map (opsional jika mau diaktifkan) */}
        {/* <motion.div
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true }}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-6 text-center">
            {warehouseInfo.locations.map((location, index) => (
              <motion.div
                ...
                custom={index}
                variants={fadeUp}
                className="p-4 bg-gray-50 rounded-lg hover:bg-red-50 transition-all duration-300"
              >
        ...
        >
          <motion.div
            variants={fadeUp}
            className="bg-gradient-to-r from-red-600 to-red-700 text-white p-8 rounded-2xl"
          >
